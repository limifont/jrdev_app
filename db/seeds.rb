...
lesson2 = Lesson.find_or_create_by(name: "Variables")
	exercise2_1 = Exercise.find_or_create_by(lesson_id: lesson2.id, name: "Variables Intro",
	...
	exercise2_2 = Exercise.find_or_create_by(lesson_id: lesson2.id, name: "Variables Cont.",
	...
	exercise2_3 = Exercise.find_or_create_by(lesson_id: lesson2.id, name: "Variable Naming",
	...
	exercise2_4 = Exercise.find_or_create_by(lesson_id: lesson2.id, name: "Variables Naming Exercise",
	...
	exercise2_5 = Exercise.find_or_create_by(lesson_id: lesson2.id, name: "Variables Naming Cont.",
		instruction: "Variables can also be a combination of words with numbers and symbols as well such as the code below. " )
	exercise2_6 = Exercise.find_or_create_by(lesson_id: lesson2.id, name: "Variables Naming Exercise Cont.",
	...
	exercise2_7 = Exercise.find_or_create_by(lesson_id: lesson2.id, name: "Variables manipulation",
	...
	exercise2_8 = Exercise.find_or_create_by(lesson_id: lesson2.id, name: "Variables manipulation cont.",
	...
	exercise2_9 = Exercise.find_or_create_by(lesson_id: lesson2.id, name: "Variables Values of strings and operations",
	...
	exercise2_10 = Exercise.find_or_create_by(lesson_id: lesson2.id, name: "Variables Values of strings and operations recap",
	...
	exercise2_11 = Exercise.find_or_create_by(lesson_id: lesson2.id, name: "Variables review",
